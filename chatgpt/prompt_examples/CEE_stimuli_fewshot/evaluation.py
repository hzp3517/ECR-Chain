...
def make_result_csv(result_dicts, save_path, full_set=True, eval_set=None):
    '''
    用于人工分析case
    '''
    if eval_set:
        dialog_dicts = load_set(eval_set)
    else:
...
if __name__ == '__main__':
    ...
    template_name = 'CEE_stimuli_fewshot'
    ...
    make_result_csv(result_dicts, save_path)
